...
import cmg.cnsim.testblockchain.TestBlockchainWorkload;
...
public class Simulation {
	...
	private static long sysEndTime = 10000000;
	...
	public void schedule(TestBlockchainWorkload dw) {
		for (Event e : dw.events) {
			this.schedule(e);
		}
	}
	...
	public void run() {
	    ...
	    while (!queue.isEmpty()){
            ...
            e.happen(this);
			if (Simulation.currTime > sysEndTime) {
				break;
			}
	    }
	}
