...
public class Event_NodeGetPennyJarRequest extends Event {
    private TestBlockchainNode node;
    private int senderId;

    public Event_NodeGetPennyJarRequest(INode node, int senderId, long time) {
    ...
    public void happen(Simulation sim) {
        super.happen(sim);
        node.event_NodeGetPennyJarRequest(senderId, getTime());
    }
}
