...
public class Event_NodeGetAccountRequest extends Event {
    private TestBlockchainNode node;
    private int senderId;

    public Event_NodeGetAccountRequest(INode node, int senderId, long time) {
    ...
    public void happen(Simulation sim) {
        super.happen(sim);
        node.event_NodeGetAccountRequest(senderId, getTime());
    }
}
