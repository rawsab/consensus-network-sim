...
public class Event_ClientTxPrepareTimeout extends Event {
    private Client client;
    List<Tx> txs;

    public Event_ClientTxPrepareTimeout(Client client, List<Tx> txs, long time) {
        this.client = client;
        this.txs = txs;
        super.setTime(time);
    }
    ...
    public void happen(Simulation sim) {
        super.happen(sim);
        client.event_ClientTxPrepareTimeout(txs, getTime());
    }
}
