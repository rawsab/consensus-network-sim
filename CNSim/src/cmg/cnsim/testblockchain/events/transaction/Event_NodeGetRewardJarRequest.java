...
public class Event_NodeGetRewardJarRequest extends Event {
    private TestBlockchainNode node;
    private int senderId;

    public Event_NodeGetRewardJarRequest(INode node, int senderId, long time) {
    ...
    public void happen(Simulation sim) {
        super.happen(sim);
        node.event_NodeGetRewardJarRequest(senderId, getTime());
    }
}
